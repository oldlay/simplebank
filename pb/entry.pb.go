...
func (x *Entry) GetAmount() *decimal.Decimal {
	if x != nil {
		return x.Amount
	}
	return nil
...
const file_entry_proto_rawDesc = "" +
	"\n" +
	"\ventry.proto\x12\x02pb\x1a\x19google/type/decimal.proto\"d\n" +
	"\x05Entry\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1d\n" +
	"\n" +
	"account_id\x18\x02 \x01(\x03R\taccountId\x12,\n" +
	"\x06amount\x18\x03 \x01(\v2\x14.google.type.DecimalR\x06amountB!Z\x1fgithub.com/oldlay/simplebank/pbb\x06proto3"
...
var file_entry_proto_depIdxs = []int32{
	1, // 0: pb.Entry.amount:type_name -> google.type.Decimal
