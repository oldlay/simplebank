...
func (x *Transfer) GetAmount() *decimal.Decimal {
	if x != nil {
		return x.Amount
	}
	return nil
...
const file_transfer_proto_rawDesc = "" +
	"\n" +
	"\x0etransfer.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19google/type/decimal.proto\"\xcf\x01\n" +
	"\bTransfer\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12&\n" +
	"\x0ffrom_account_id\x18\x02 \x01(\x03R\rfromAccountId\x12\"\n" +
	"\rto_account_id\x18\x03 \x01(\x03R\vtoAccountId\x12,\n" +
	"\x06amount\x18\x04 \x01(\v2\x14.google.type.DecimalR\x06amount\x129\n" +
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAtB!Z\x1fgithub.com/oldlay/simplebank/pbb\x06proto3"
...
var file_transfer_proto_depIdxs = []int32{
	1, // 0: pb.Transfer.amount:type_name -> google.type.Decimal
	2, // 1: pb.Transfer.created_at:type_name -> google.protobuf.Timestamp
